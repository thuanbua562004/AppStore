...
import com.example.appstore.Constant.AppInfo;
import com.example.appstore.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Thanh toan cho don hang AppStore #" + Helpers.getAppTransId();
